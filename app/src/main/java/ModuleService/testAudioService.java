...
public class testAudioService extends Service {
        ...
        new Thread(new Runnable() {
            ...
            public synchronized void run() {
                try {
                    ...
                    Thread.sleep(5000); // 5 초 동안 녹음
                    recorder.stop(); // 레코더 중지
                    handler2.sendEmptyMessage(0);

                }catch (InterruptedException e){
                    System.err.print("testAudioService InterruptedException error");
                } catch (IOException e) {
                    System.err.print("testAudioService IOException error");
                }finally {
                    if(recorder != null){
